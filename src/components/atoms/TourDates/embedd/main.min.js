				...
				'[object Array]' === o.call(t)
					? (function(t, e, n) {
							for (var i = 0, o = t.length; i < o; i++)
								r.call(t, i) && (null == n ? e(t[i], i, t) : e.call(n, t[i], i, t));
					  })(t, e, a)
					: 'string' == typeof t
						? (function(t, e, n) {
								for (var i = 0, o = t.length; i < o; i++)
									null == n ? e(t.charAt(i), i, t) : e.call(n, t.charAt(i), i, t);
						  })(t, e, a)
						: (function(t, e, n) {
								for (var i in t) r.call(t, i) && (null == n ? e(t[i], i, t) : e.call(n, t[i], i, t));
						  })(t, e, a);
		};
	},
	function(t, e) {
		...
		function r(t, e) {
			...
			var r,
				a = !0 === e.prepend ? 'prepend' : 'append',
				s = void 0 !== e.container ? e.container : document.querySelector('head'),
				c = n.indexOf(s);
			return (
				-1 === c && ((c = n.push(s) - 1), (i[c] = {})),
				void 0 !== i[c] && void 0 !== i[c][a]
					? (r = i[c][a])
					: ((r = i[c][a] = (function() {
							var t = document.createElement('style');
							return t.setAttribute('type', 'text/css'), t;
					  })()),
					  'prepend' === a ? s.insertBefore(r, s.childNodes[0]) : s.appendChild(r)),
					...
					switch (t.arrayFormat) {
						case 'index':
							return function(t, n, i) {
								(e = /\[(\d*)\]$/.exec(t)),
									(t = t.replace(/\[\d*\]$/, '')),
									e ? (void 0 === i[t] && (i[t] = {}), (i[t][e[1]] = n)) : (i[t] = n);
							};
						case 'bracket':
							return function(t, n, i) {
								(e = /(\[\])$/.exec(t)),
									(t = t.replace(/\[\]$/, '')),
									e ? (void 0 !== i[t] ? (i[t] = [].concat(i[t], n)) : (i[t] = [n])) : (i[t] = n);
							};
						default:
								...
								if (Array.isArray(o)) {
									...
									return (
										o.slice().forEach(function(t) {
											void 0 !== t && r.push(n(i, t, r.length));
										}),
										r.join('&')
									);
								}
 ...
 */ function i(
			...
			return (e = null == e ? n || 0 : e < 0 ? Math.max(t + e, 0) : Math.min(e, t));
		}
		t.exports = function(t, e, n) {
			var o = t.length,
				r = [];
 ...
 */ t.exports = function(
	...
	function(t, e, n) {
		...
		!(function(e) {
			...
			function s(t) {
				for (var e, n, i = {}, o = /^data\-/, r = t.attributes.length, s = -1; ++s < r; )
					(n = (e = t.attributes[s]).name), o.test(n) && (i[(n = a((n = n.replace(o, ''))))] = e.value);
				return i;
			}
			void 0 ===
				(i = function() {
...
*/ var i = Object.getOwnPropertySymbols,
	...
	function(t, e, n) {
		...
		function a(t) {
			try {
				...
				for (var e = t.match(i), n = 1; n < e.length; n++) e = (t = r(e, n).join('')).match(i);
				return t;
			}
		}
		t.exports = function(t) {
	...
	function(t, e, n) {
		'use strict';
		n.r(e),
			n.d(e, 'formatWhiteSpaceChracters', function() {
				return i;
			}),
			n.d(e, 'stripHTMLText', function() {
				return o;
			});
		var i = function(t) {
			...
			o = function(t) {
				...
				return (e.innerHTML = t), i(e.firstChild.textContent) || i(e.firstChild.innerText) || '';
			};
	},
	function(t, e, n) {
		'use strict';
 ...
 */ var i = n(
	...
	function(t) {
		t.exports = {
			...
			'On Sale': 'On Sale',
			'Notify Me': 'Notify Me',
			'<span>Track</span> to get concert and tour updates.':
				'<span>Track</span> to get concert and tour updates.',
			Free: 'Free',
			'Play My City': 'Play My City',
			'': '',
		};
	},
	function(t) {
		t.exports = {
			...
			'<b>Track</b> to get notified about upcoming shows in your area.':
				'<b>Suivre</b> pour recevoir les dates des prochains concerts dans votre région.',
			Track: 'Suivre',
			RSVP: 'RSVP',
			...
			'<span>Track</span> to get concert and tour updates.':
				'<span>Suivre</span> pour recevoir news et info concerts .',
			Free: 'Gratuit',
			'Play My City': 'Jouer dans ma ville',
			'': '',
		};
	},
	function(t) {
		t.exports = {
			...
			'<b>Track</b> to get notified about upcoming shows in your area.':
				'<b>Folgen</b> um zukünftige Konzerte in deiner Region zu finden.',
			Track: 'Folgen',
			RSVP: 'RSVP',
			...
			'<span>Track</span> to get concert and tour updates.':
				'<span>Folgen</span> um zukünftige Konzerte in deiner Region zu finden.',
			Free: 'Kostenlos',
			'Play My City': 'Spiel in meiner Stadt',
			'': '',
		};
	},
	function(t) {
		t.exports = {
			...
			'<b>Track</b> to get notified about upcoming shows in your area.':
				'<b>Seguir</b> para obtener notificaciones sobre fechas próximas en tu área.',
			Track: 'Seguir',
			RSVP: 'RSVP',
			...
			'<span>Track</span> to get concert and tour updates.':
				'<span>Seguir</span> para obtener notificaciones de conciertos.',
			Free: 'Gratis',
			'Play My City': 'Actuad en mi ciudad',
			'': '',
		};
	},
	function(t) {
		t.exports = {
			...
			'<b>Track</b> to get notified about upcoming shows in your area.':
				'<b>Segui</b> per ricevere le notifiche sugli spettacoli in programma nella tua zona.',
			Track: 'Segui',
			'Notify Me': 'Notify Me',
			RSVP: 'RSVP',
			Free: 'Gratis',
	...
	function(t) {
		t.exports = {
			...
			'<b>Track</b> to get notified about upcoming shows in your area.':
				'<b>フォロー</b>して、お住まいの地域で近日開催予定のライブに関する通知を受け取ってください。',
			Track: 'フォロー',
			RSVP: '参加予定',
			'I Was There': '行きました。',
			'On Sale': '発売中',
			'Notify Me': '通知を受ける',
			'<span>Track</span> to get concert and tour updates.':
				'<span>フォロー</span>して、コンサート情報や最新ツアー情報をゲット。',
			Free: '無料',
			'Play My City': '所在地での公演依頼',
			'': '',
		};
	},
	function(t) {
		t.exports = {
			...
			'<b>Track</b> to get notified about upcoming shows in your area.':
				'<b>Seguir</b> para receber notificações dos próximos concertos na tua área.',
			Track: 'Seguir',
			...
			'<span>Track</span> to get concert and tour updates.':
				'<span>Seguir</span> para receber notificações dos próximos concertos na tua área.',
			Free: 'Gratuito',
			'Play My City': 'Toca na minha cidade',
			'': '',
		};
	},
	function(t, e) {
 ...
 */
			!(function(e, n) {
				...
				function v() {
					for (var t = 0; t < o; t += 2) {
						(0, b[t])(b[t + 1]), (b[t] = void 0), (b[t + 1] = void 0);
					}
					o = 0;
				}
				var h = void 0;
				...
				function j(e, n, i) {
					n.constructor === e.constructor && i === m && n.constructor.resolve === g
						? (function(t, e) {
								e._state === I
									? M(t, e._result)
									: e._state === k
				...
				function M(t, e) {
					t._state === x && ((t._result = e), (t._state = I), 0 !== t._subscribers.length && s(C, t));
				}
				function O(t, e) {
					t._state === x && ((t._state = k), (t._result = e), s(T, t));
				}
				function N(t, e, n, i) {
					var o = t._subscribers,
						r = o.length;
					(t._onerror = null), (o[r] = e), (o[r + I] = n), (o[r + k] = i), 0 === r && t._state && s(C, t);
				}
				function C(t) {
				...
				function E(e, n, i, o) {
					...
					n._state !== x || (r && c ? _(n, a) : l ? O(n, s) : e === I ? M(n, a) : e === k && O(n, a));
				}
				var D = 0;
				function Z(t) {
					(t[y] = D++), (t._state = void 0), (t._result = void 0), (t._subscribers = []);
				}
				var L = (function() {
					function t(t, e) {
						(this._instanceConstructor = t),
							(this.promise = new t(w)),
							this.promise[y] || Z(this.promise),
							i(e)
					...
					return (
						...
						(t.prototype._eachEntry = function(t, e) {
							...
							if (i === g) {
								var o = S(t);
								if (o === m && t._state !== x) this._settledAt(t._state, e, t._result);
								else if ('function' != typeof o) this._remaining--, (this._result[e] = t);
								else if (n === A) {
									var r = new n(w);
									j(r, t, o), this._willSettleAt(r, e);
								} else
									this._willSettleAt(
										new n(function(e) {
											return e(t);
						...
						(t.prototype._settledAt = function(t, e, n) {
							var i = this.promise;
							i._state === x && (this._remaining--, t === k ? O(i, n) : (this._result[e] = n)),
				...
				return (
					...
					(A._setScheduler = function(t) {
						a = t;
					}),
					(A._setAsap = function(t) {
						s = t;
					}),
					(A._asap = s),
					(A.polyfill = function() {
	...
	function(t, e) {
		...
		(o.nextTick = function(t) {
			...
			l.push(new b(t, e)), 1 !== l.length || u || s(d);
		}),
	...
	function(t, e, n) {
		...
		function p(t, e) {
			...
			for (e && null != e.children && (l.length || l.push(e.children), delete e.children); l.length; )
				if ((i = l.pop()) && void 0 !== i.pop) for (r = i.length; r--; ) l.push(i[r]);
				else
						...
						(o = 'function' != typeof t) &&
							(null == i
								...
								: 'number' == typeof i
									? (i = String(i))
									: 'string' != typeof i && (o = !1)),
						o && n ? (a[a.length - 1] += i) : a === u ? (a = [i]) : a.push(i),
						(n = o);
			var p = new s();
			return (
				(p.nodeName = t),
		...
		var d = 'function' == typeof Promise ? Promise.resolve().then.bind(Promise.resolve()) : setTimeout;
		var b = /acit|ex(?:s|g|n|p|$)|rph|ows|mnc|ntw|ine[ch]|zoo|^ord/i,
			v = [];
		function h(t) {
			!t._dirty && (t._dirty = !0) && 1 == v.push(t) && (c.debounceRendering || d)(m);
		}
		function m() {
			var t,
				e = v;
			for (v = []; (t = e.pop()); ) t._dirty && A(t);
		}
		function g(t, e, n) {
			return 'string' == typeof e || 'number' == typeof e
				? void 0 !== t.splitText
				: 'string' == typeof e.nodeName
					? !t._componentConstructor && y(t, e.nodeName)
		...
		function w(t) {
			var e = f({}, t.attributes);
			e.children = t.children;
			var n = t.nodeName.defaultProps;
			if (void 0 !== n) for (var i in n) void 0 === e[i] && (e[i] = n[i]);
			return e;
		}
		function x(t) {
			var e = t.parentNode;
			...
			if (('className' === e && (e = 'class'), 'key' === e));
				...
				if ('style' === e) {
					if (
						...
						if ('string' != typeof n) for (var r in n) r in i || (t.style[r] = '');
						for (var r in i) t.style[r] = 'number' == typeof i[r] && !1 === b.test(r) ? i[r] + 'px' : i[r];
					}
				} else if ('dangerouslySetInnerHTML' === e) i && (t.innerHTML = i.__html || '');
				else if ('o' == e[0] && 'n' == e[1]) {
					var a = e !== (e = e.replace(/Capture$/, ''));
					(e = e.toLowerCase().substring(2)),
						i ? n || t.addEventListener(e, k, a) : t.removeEventListener(e, k, a),
		...
		var P = [],
			...
			_ = !1;
		function T() {
			for (var t; (t = P.pop()); ) c.afterMount && c.afterMount(t), t.componentDidMount && t.componentDidMount();
		}
		function M(t, e, n, i, o, r) {
			S++ || ((j = null != o && void 0 !== o.ownerSVGElement), (_ = null != t && !('__preactattr_' in t)));
			var a = O(t, e, n, i, r);
			return o && a.parentNode !== o && o.appendChild(a), --S || ((_ = !1), r || T()), a;
		}
		function O(t, e, n, i, o) {
				...
				return (
					t && void 0 !== t.splitText && t.parentNode && (!t._component || o)
						...
						: ((r = document.createTextNode(e)),
						  t && (t.parentNode && t.parentNode.replaceChild(r, t), N(t, !0))),
					(r.__preactattr_ = !0),
					r
				);
			var s = e.nodeName;
			if ('function' == typeof s)
				return (function(t, e, n, i) {
					...
					o && c && (!i || o._component)
						? (L(o, l, 3, n, i), (t = o.base))
						: (r && !s && (U(r), (t = a = null)),
						  (o = D(e.nodeName, l, n)),
						  t && !o.nextBase && ((o.nextBase = t), (a = null)),
						  L(o, l, 1, n, i),
						  (t = o.base),
						  a && t !== a && ((a._component = null), N(a, !1)));
					return t;
				})(t, e, n, i);
			if (
			...
			if (null == l) {
				l = r.__preactattr_ = {};
				for (var p = r.attributes, f = p.length; f--; ) l[p[f].name] = p[f].value;
			}
			return (
				!_ &&
				u &&
				...
				void 0 !== c.splitText &&
				null == c.nextSibling
					? c.nodeValue != u[0] && (c.nodeValue = u[0])
					: ((u && u.length) || null != c) &&
					  (function(t, e, n, i, o) {
							var r,
								a,
							...
							if (0 !== v)
								for (var y = 0; y < v; y++) {
									var w = u[y],
										I = w.__preactattr_,
										k = m && I ? (w._component ? w._component.__key : I.key) : null;
									null != k
										? (d++, (f[k] = w))
										: (I || (void 0 !== w.splitText ? !o || w.nodeValue.trim() : o)) &&
										  (p[h++] = w);
								}
							if (0 !== m)
								for (var y = 0; y < m; y++) {
									(c = e[y]), (l = null);
									var k = c.key;
									if (null != k) d && void 0 !== f[k] && ((l = f[k]), (f[k] = void 0), d--);
									else if (b < h)
										for (r = b; r < h; r++)
											if (void 0 !== p[r] && g((a = p[r]), c, o)) {
												(l = a), (p[r] = void 0), r === h - 1 && h--, r === b && b++;
												break;
											}
									(l = O(l, c, n, i)),
										(s = u[y]),
							...
							if (d) for (var y in f) void 0 !== f[y] && N(f[y], !1);
							for (; b <= h; ) void 0 !== (l = p[h--]) && N(l, !1);
					  })(r, u, n, i, _ || null != l.dangerouslySetInnerHTML),
				(function(t, e, n) {
					var i;
					for (i in n) (e && null != e[i]) || null == n[i] || I(t, i, n[i], (n[i] = void 0), j);
					for (i in e)
						'children' === i ||
							'innerHTML' === i ||
							(i in n && e[i] === ('value' === i || 'checked' === i ? t[i] : n[i])) ||
							I(t, i, n[i], (n[i] = e[i]), j);
				})(r, e.attributes, l),
				(j = a),
				r
		...
		function N(t, e) {
			...
			n
				? U(n)
				: (null != t.__preactattr_ && t.__preactattr_.ref && t.__preactattr_.ref(null),
		...
		function D(t, e, n) {
			...
			for (
				t.prototype && t.prototype.render
					? ((i = new t(e, n)), W.call(i, e, n))
					: (((i = new W(e, n)).constructor = t), (i.render = Z));
				o--;

			)
				if (E[o].constructor === t) return (i.nextBase = E[o].nextBase), E.splice(o, 1), i;
			return i;
		}
		function Z(t, e, n) {
			...
			t._disable ||
				...
				void 0 === t.constructor.getDerivedStateFromProps &&
					(!t.base || o
						...
						: t.componentWillReceiveProps && t.componentWillReceiveProps(e, i)),
				i && i !== t.context && (t.prevContext || (t.prevContext = t.context), (t.context = i)),
				t.prevProps || (t.prevProps = t.props),
				(t.props = e),
				(t._disable = !1),
				0 !== n && (1 !== n && !1 === c.syncComponentUpdates && t.base ? h(t) : A(t, 1, o)),
				t.__ref && t.__ref(t));
		}
		function A(t, e, n, i) {
			if (!t._disable) {
				...
				if (
					(t.constructor.getDerivedStateFromProps &&
						((l = f(f({}, l), t.constructor.getDerivedStateFromProps(s, l))), (t.state = l)),
					v &&
						((t.props = p),
						(t.state = d),
						(t.context = b),
						2 !== e && t.shouldComponentUpdate && !1 === t.shouldComponentUpdate(s, l, u)
							? (y = !0)
							: t.componentWillUpdate && t.componentWillUpdate(s, l, u),
						(t.props = s),
						(t.state = l),
						(t.context = u)),
					...
					(o = t.render(s, l, u)),
						t.getChildContext && (u = f(f({}, u), t.getChildContext())),
						v && t.getSnapshotBeforeUpdate && (x = t.getSnapshotBeforeUpdate(p, d));
					var I,
						k,
						j = o && o.nodeName;
					if ('function' == typeof j) {
						var _ = w(o);
						(r = g) && r.constructor === j && _.key == r.__key
							? L(r, _, 1, u, !1)
							: ((I = r),
							  (t._component = r = D(j, _, u)),
						...
						(a = m),
							(I = g) && (a = t._component = null),
							(m || 1 === e) &&
								(a && (a._component = null), (k = M(a, o, u, n || !v, m && m.parentNode, !0)));
					if (m && k !== m && r !== g) {
						var O = m.parentNode;
						O && k !== O && (O.replaceChild(k, m), I || ((m._component = null), N(m, !1)));
					}
					if ((I && U(I), (t.base = k), k && !i)) {
						for (var C = t, E = t; (E = E._parentComponent); ) (C = E).base = k;
				...
				for (
					!v || n
						? P.unshift(t)
						: y ||
						  (t.componentDidUpdate && t.componentDidUpdate(p, d, x), c.afterUpdate && c.afterUpdate(t));
		...
		f(W.prototype, {
			setState: function(t, e) {
				this.prevState || (this.prevState = this.state),
					(this.state = f(f({}, this.state), 'function' == typeof t ? t(this.state, this.props) : t)),
					e && this._renderCallbacks.push(e),
					h(this);
			},
			forceUpdate: function(t) {
				t && this._renderCallbacks.push(t), A(this, 2);
			},
			render: function() {},
		});
		var R = n(2),
		...
		var V = function(t, e) {
				...
				return ''.concat(i, '?').concat(B.a.stringify(o));
			},
			z = {
		...
		var K = function(t, e) {
				var n = t.offers,
					i = e.polyglot;
				return 0 === n.length ? i.t('Notify Me') : 1 === n.length ? i.t(n[0].type) : i.t('Tickets & More');
			},
			q = function(t) {
				var e = t.lineup;
				return e.length > 1 ? e.slice(1).join(', ') : null;
			},
			Q = function(t, e) {
				var n = e.trackingParams,
					i = t.url,
					o = H({}, n, { utm_campaign: 'event' });
				return V(i, o);
			},
			$ = function(t) {
				return t.venue.name;
			...
			tt = function(t) {
				var e = t.venue;
				return 'United States' === e.country
					? ''.concat(e.city, ', ').concat(e.region)
					: ''.concat(e.city, ', ').concat(e.country);
			},
			et = function(t, e) {
				var n = e.language,
					i = new Date();
				return new Date(t).getYear() === i.getYear()
					? (function(t, e) {
							var n = J(t),
								i = n.getDate(),
								o = n.getMonth(),
							...
							switch (e) {
								case 'en':
									return ''
										.concat(Y[r], ', ')
										.concat(z.en[o].toUpperCase(), ' ')
										.concat(i);
								case 'de':
									return ''.concat(i, '. ').concat(z.de[o], '.');
								case 'es':
									return ''.concat(i, ' ').concat(z.es[o], '.');
								case 'fr':
									return ''.concat(i, ' ').concat(z.fr[o]);
								case 'it':
									return ''.concat(i, ' ').concat(z.it[o]);
								case 'pt':
									return ''.concat(i, ' ').concat(z.pt[o]);
								case 'ja':
									return ''.concat(z.ja[o]).concat(i, '日');
								default:
									return ''
										.concat(Y[i.getDay()], ', ')
										.concat(z.en[o].toUpperCase(), ' ')
			...
			nt = function(t, e) {
				var n = t.offers,
					i = e.trackingParams;
				if (0 === n.length) {
					return V(Q(t, e), { utm_campaign: 'notify_me', trigger: 'notify_me' });
				}
				if (1 === n.length) {
					var o = H({}, i, { utm_campaign: 'ticket' });
					return V(n[0].url, o);
				}
				return null;
			},
			it = function(t, e) {
				var n = t.offers,
					i = e.polyglot,
					o = H({}, e.trackingParams, { utm_campaign: 'ticket' });
				return n.map(function(t) {
					var e = t.url,
						n = t.type;
					return { url: V(e, o), type: i.t(n) };
				});
			},
			ot = function(t, e) {
				var n = H({}, e.trackingParams, { utm_campaign: 'rsvp', trigger: 'rsvp_going' });
				return V(Q(t, e), n);
			};
		function rt(t, e, n) {
			return (
		...
		var at = function(t, e) {
				var n = t.id,
					i = 'https://www.bandsintown.com/a/'.concat(n),
					o = (function(t) {
						for (var e = 1; e < arguments.length; e++) {
							var n = null != arguments[e] ? arguments[e] : {},
								i = Object.keys(n);
						...
						return t;
					})({}, e.trackingParams, { utm_campaign: 'artist' });
				return V(i, o);
			},
			st = function(t, e) {
				var n = at(t, e);
				return V(n, { utm_campaign: 'track', trigger: 'track' });
			},
			ct = function(t, e) {
				var n = t.events,
					i = t.artist,
					...
					c = r.displayLineup,
					l = r.displayDetails,
					u = r.displayPlayMyCity,
					p = a ? '_self' : '_blank';
				return {
					tooManyEvents: n.length > s,
					displayLimit: s,
					showAllDatesText: o.t('Show All Dates'),
					playMyCityText: o.t('Play My City'),
					playMyCityUrl: (function(t, e) {
						var n = at(t, e);
						return V(n, { utm_campaign: 'play_my_city', trigger: 'play_my_city' });
					})(i, e),
					linkTarget: p,
					displayPlayMyCity: u,
					events: n.map(function(t) {
						return {
							date: et(t.datetime, e),
							location: tt(t),
							venue: $(t),
							displayLineup: c,
							lineUp: q(t),
							...
							onSaleDate: (function(t, e) {
								var n = e.polyglot,
									i = e.widgetOptions.displayDetails,
									o = t.on_sale_datetime;
								return i && o ? ''.concat(n.t('On Sale'), ': ').concat(et(o, e)) : '';
							})(t, e),
							ticketsData: { defaultTicketUrl: nt(t, e), offers: it(t, e), offersText: K(t, e) },
						};
					}),
				};
			},
			...
			ut = function(t) {
				var e = t.userLocation,
					n = t.events;
				return e && e.longitude && e.latitude
					? n.filter(function(t) {
							var n = t.venue;
							return (
								!(!n.longitude || !n.latitude) &&
								(function(t, e) {
									var n = lt(e.latitude - t.latitude),
										i = lt(e.longitude - t.longitude),
										o =
											Math.sin(n / 2) * Math.sin(n / 2) +
											Math.cos(lt(t.latitude)) *
												Math.cos(lt(e.latitude)) *
												Math.sin(i / 2) *
												Math.sin(i / 2);
									return 2 * Math.atan2(Math.sqrt(o), Math.sqrt(1 - o)) * 3959;
								})(e, n) < 100
							);
					  })
					: [];
			...
			pt = n(15),
			ft = function(t) {
				return t.events.map(function(t) {
					return {
						...
						name: (function(t) {
							var e = t.lineup,
								...
								i = e
									...
									.join(', ');
							return ''.concat(i, ' @ ').concat(n.name);
						})(t),
						startDate: t.datetime,
						url: (function(t) {
							return V(t.url, { came_from: 242 });
						})(t),
						location: (function(t) {
							var e = 'United States' === t.country;
							return {
								'@type': 'Place',
								name: pt.stripHTMLText(t.name),
								address: {
									'@type': 'PostalAddress',
						...
						performers: (function(t) {
							return t.map(function(t) {
								return { '@type': 'MusicGroup', name: t };
							});
						})(t.lineup),
			...
			dt = function(t, e) {
				...
				return {
					eventsContainer: {
						upcomingEvents: ct(t, e),
						displayNoUpcomingEvents: 0 === n.length,
						pastEvents: (function(t, e) {
							var n = t.pastEvents;
							if (!n) return {};
							var i = e.polyglot,
								o = e.widgetOptions,
								...
								s = o.displayLineup;
							return {
								tooManyEvents: n.length > a,
								displayLimit: a,
								showAllDatesText: i.t('Show All Dates'),
								pastEvents: n
									.map(function(t) {
										return {
											date: et(t.datetime, e),
											...
											venue: $(t),
											lineUp: q(t),
											rsvp: i.t('I Was There'),
											rsvpUrl: ot(t, e),
											eventUrl: Q(t, e),
											linkTarget: r ? '_self' : '_blank',
											displayLineup: s,
										};
									})
									.reverse(),
						...
						noUpcomingEvents: (function(t, e) {
							var n = e.polyglot,
								i = e.isMobile,
								o = t.artist;
							return {
								noUpcomingTourDatesText: n.t('No Upcoming Tour Dates'),
								trackArtistDescription: n.t(
									'<b>Track</b> to get notified about upcoming shows in your area.'
								),
								trackArtistUrl: st(o, e),
								trackText: n.t('Track'),
								linkTarget: i ? '_self' : '_blank',
							};
						})(t, e),
						iframeSrc: (function(t, e) {
							var n = t.artist,
								i = e.trackingParams,
								o = {
									affil_code: i.affil_code,
									app_id: i.app_id,
									artist_id: n.id,
									artist_name: n.name,
									came_from_code: i.came_from,
								};
							return V('https://widget.bandsintown.com/widget_iframe.html', o);
						})(t, e),
					},
					navigationBar: (function(t, e) {
						var n = t.artist,
							i = e.polyglot,
							o = e.widgetOptions,
							r = e.isMobile,
							a = o.displayPastDates,
							s = o.displayLogo;
						return {
							artistUrl: at(n, e),
							displayPastDates: a,
							displayLogo: s,
							upcomingDatesText: i.t('Upcoming Dates'),
							pastDatesText: i.t('Past Dates'),
							linkTarget: r ? '_self' : '_blank',
						};
					})(t, e),
					trackButton: (function(t, e) {
						var n = t.artist,
							i = e.polyglot;
						return {
							trackUrl: st(n, e),
							trackDescription: i.t('<span>Track</span> to get concert and tour updates.'),
						};
					})(t, e),
					localEvents: (function(t, e) {
						var n = e.widgetOptions.displayLocalDates,
							i = t.userLocation;
						if (!n || !i) return null;
						var o = ut(t),
							r = e.widgetOptions.displayLineup,
							a = e.polyglot,
							s = e.isMobile;
						return {
							tooManyEvents: o.length > 5,
							displayLimit: 5,
							showAllDatesText: a.t('Show All Dates'),
							title: a.t('Local Dates'),
		...
		var wt = (function(t) {
				function e(t) {
					...
					return (
						...
						})(this, mt(e).call(this, t))).state = {
							displayTickets: !1,
							transparencyClass: 'bit-transparent',
							displayClass: 'bit-display-none',
						}),
						(n.toggleDisplayTickets = n.toggleDisplayTickets.bind(yt(yt(n)))),
						n
					);
				}
				return (
							...
							value: function() {
								var t = this.state,
									...
									s = r.map(function(t) {
										return p(
											'a',
											{ className: 'bit-offer', href: t.url, target: a, 'aria-label': t.type },
											t.type
										);
									});
								return p(
									...
									p(
										'div',
										{ className: 'bit-offers bit-button', onClick: this.toggleDisplayTickets },
										p('span', { className: 'bit-offers-text' }, o),
										p('div', {
											className: 'bit-overlay '.concat(n),
											onClick: this.toggleDisplayTickets,
										}),
										p(
											'div',
											{ className: 'bit-offers-menu bit-button '.concat(e, ' ').concat(n) },
											s
										)
									)
								);
			...
			xt = function(t) {
				var e = t.lineUp,
					...
					v = f.offers,
					h = f.offersText,
					m = f.defaultTicketUrl;
				return p(
					'div',
					{ className: 'bit-event' },
					p(
						'a',
						{ className: 'bit-details', href: b, target: u },
						...
						d &&
							...
							p(
								...
								p('span', { className: 'bit-lineUp-with' }, s),
					...
					p(
						...
						p(
							...
							p('a', { className: 'bit-rsvp bit-button', href: l, target: u, 'aria-label': c }, c)
						),
						v.length > 1
							? p(wt, { offers: v, offersText: h, linkTarget: u })
							: p(
									'div',
									{ className: 'bit-offers-container' },
									p(
										'a',
										{ className: 'bit-offers bit-button', target: u, href: m, 'aria-label': h },
										p('span', { className: 'bit-offers-text' }, h)
									)
							  )
					)
				);
		...
		var _t = (function(t) {
				function e(t) {
					...
					!(function(t, e) {
						...
						(n = (function(t, e) {
							return !e || ('object' !== It(e) && 'function' != typeof e) ? jt(t) : e;
						})(this, Pt(e).call(this, t)));
					var i = t.tooManyEvents;
					return (n.state = { showingAllEvents: !i }), (n.showAllEvents = n.showAllEvents.bind(jt(jt(n)))), n;
				}
				return (
					(function(t, e) {
						if ('function' != typeof e && null !== e)
					...
					(function(t, e, n) {
					...
					})(e, [
						{
							key: 'showAllEvents',
							value: function() {
								this.state.showingAllEvents || this.setState({ showingAllEvents: !0 });
							},
						},
						{
							key: 'render',
							value: function() {
								...
								return p(
									...
									p('div', { className: 'bit-upcoming-events' }, t ? u : u.slice(0, r)),
									i &&
										!t &&
										p(
											'div',
									...
									l && t && p('a', { className: 'bit-play-my-city-button', href: s, target: c }, a)
								);
							},
						},
					]),
			...
			Tt = function(t) {
				...
				return p(
					...
					p(
						'a',
						{ className: 'bit-details', href: t.eventUrl, target: u },
						p('div', { className: 'bit-date' }, o),
						p('div', { className: 'bit-venue' }, r),
						p('div', { className: 'bit-location' }, a),
						f &&
					...
					p(
						...
						p(
							'div',
							{ className: 'bit-rsvp-container' },
							p('a', { className: 'bit-rsvp bit-button', href: l, target: u }, c)
						)
					)
				);
			};
		...
		var Dt = (function(t) {
				function e(t) {
					...
					!(function(t, e) {
						...
						(n = (function(t, e) {
							return !e || ('object' !== Mt(e) && 'function' != typeof e) ? Et(t) : e;
						})(this, Nt(e).call(this, t)));
					var i = t.tooManyEvents;
					return (n.state = { showingAllEvents: !i }), (n.showAllEvents = n.showAllEvents.bind(Et(Et(n)))), n;
				}
				return (
					(function(t, e) {
						if ('function' != typeof e && null !== e)
						...
						},
						{
							...
							value: function() {
								...
								return p(
									'div',
									{ className: 'bit-upcoming-events-container' },
									p('div', { className: 'bit-past-events' }, t ? a : a.slice(0, r)),
									i &&
										!t &&
										p(
											'div',
				...
				return p(
					...
					n &&
						p(
							'div',
							null,
							p('div', { dangerouslySetInnerHTML: { __html: n } }),
							p('div', null, p('a', { className: 'bit-button bit-track-button bit-offers', href: i }, o))
						)
				);
			},
			Lt = function(t) {
				...
				return p(
					...
					p(
						...
						o ? p(Dt, i) : r ? p(Zt, n) : p(_t, e),
						p('iframe', { src: a, className: 'google-pixel-iframe' })
					)
				);
			},
			At = function() {
				return p(
					'svg',
					{ width: '23px', height: '20px', viewBox: '0 0 23 24' },
					p(
						'g',
						{
							id: 'Page-1',
			...
			Ut = function() {
				return p(
					'svg',
					{ width: '144', height: '20', viewBox: '0 0 172 24' },
					p(
						'defs',
						null,
						p('path', {
					...
					p(
						'g',
						{ fill: 'none', 'fill-rule': 'evenodd', opacity: '0.402400362' },
						p(
							'g',
							{ transform: 'translate(29.522 3.243)' },
							p('mask', { id: 'b', fill: '#fff' }, p('use', { xlinkHref: '#a' })),
							p('path', { fill: '#A9A9A9', d: 'M-.013 18.506H142.04V-.02H-.013z', mask: 'url(#b)' })
						),
						p('path', {
							fill: '#A9A9A9',
							d:
				...
				return p(
					...
					p(
						...
						p(
							'span',
							{
								className: 'bit-event-list-title bit-show-upcoming '.concat(s ? 'bit-clickable' : ''),
								onClick: i,
							},
							r
						),
						o &&
							p(
								'span',
								{
									className: 'bit-event-list-title bit-show-past '.concat(s ? '' : 'bit-clickable'),
									onClick: n,
								},
								a
							),
						c &&
							p(
								...
								p(
									...
									p(
										'a',
										{ href: e, target: l, className: 'bit-logo-link' },
										p('div', { className: 'bit-logo-desktop' }, p(Ut, null)),
										p('div', { className: 'bit-logo-mobile' }, p(At, null))
									)
								)
							)
					)
		...
		var Yt = (function(t) {
			function e(t) {
				...
				!(function(t, e) {
					...
					(n = (function(t, e) {
						return !e || ('object' !== Rt(e) && 'function' != typeof e) ? zt(t) : e;
					})(this, Ft(e).call(this, t)));
				var i = t.tooManyEvents;
				return (n.state = { showingAllEvents: !i }), (n.showAllEvents = n.showAllEvents.bind(zt(zt(n)))), n;
			}
			return (
				(function(t, e) {
					if ('function' != typeof e && null !== e)
					...
					},
					{
						...
						value: function() {
							...
							return p(
								...
								p('div', { className: 'bit-event-list-title' }, a),
								p('div', { className: 'bit-local-events' }, t ? s : s.slice(0, r)),
								i &&
									!t &&
									p(
										'div',
		...
		var Ht = function(t) {
				...
				if (!e) return p('div', { className: 'bit-widget' }, p(bt, null));
				var l = e.navigationBar,
					u = e.eventsContainer,
					f = e.trackButton,
					d = e.localEvents,
					b = o.widgetOptions,
					v = b.displayLocalDates,
					h = b.displayTrackButton;
				return p(
					'div',
					{ className: 'bit-widget '.concat(n, ' ').concat(i) },
					v && d && p(Yt, d),
					h && p(Gt, f),
					p(Wt, Jt({}, l, { showingPastEvents: a, handlePastEventsClick: s, handleUpcomingEventsClick: c })),
					r ? p(bt, null) : p(Lt, Jt({}, u, { showingPastEvents: a }))
				);
			},
			Xt = n(3),
			Kt = n.n(Xt),
					...
					!(function(t, e, n) {
						...
						(i.onreadystatechange = function() {
							i.readyState === XMLHttpRequest.DONE &&
								(200 === i.status && e ? e(JSON.parse(i.responseText)) : n && n(i));
						}),
							i.open('GET', t, !0),
							i.send();
					})(
			...
			$t = function(t) {
				return new Promise(function(e, n) {
					(function(t) {
						var e = t.appId,
							n = t.artistName,
							i = { app_id: e || 'js_'.concat(window.location.hostname) },
							o = 'https://rest.bandsintown.com/artists/'.concat(n, '/events'),
							r = V(o, i);
						return Kt()(r, { jsonpCallbackFunction: Qt() }).then(function(t) {
							return t.json();
						});
					})(t)
						.then(function(n) {
							n.length > 0
								? e({ events: n, artist: { id: n[0].artist_id, name: n[0].lineup[0] } })
								: (function(t) {
										var e = t.appId,
											n = t.artistName,
											i = { app_id: e || 'js_'.concat(window.location.hostname) },
											o = 'https://rest.bandsintown.com/artists/'.concat(n),
											r = V(o, i);
										return qt(r);
								  })(t).then(function(t) {
										e({ events: n, artist: t });
		...
		var ue = (function(t) {
				function e(t) {
					...
					return (
						...
						((n = (function(t, e) {
							return !e || ('object' !== ne(e) && 'function' != typeof e) ? le(t) : e;
						})(this, se(e).call(this, t))).state = {
							rawData: {},
							data: null,
							responsiveLayout: '',
						...
						(n.handleBreakpoints = n.handleBreakpoints.bind(le(le(n)))),
						(n.fetchPastEventsData = n.fetchPastEventsData.bind(le(le(n)))),
						(n.handlePastEventsClick = n.handlePastEventsClick.bind(le(le(n)))),
						(n.handleUpcomingEventsClick = n.handleUpcomingEventsClick.bind(le(le(n)))),
						(n.getUserLocation = n.getUserLocation.bind(le(le(n)))),
						n
					);
				}
				return (
					...
					})(e, [
						{
							...
							value: function() {
								...
								this.handleBreakpoints(),
									...
									$t(e.widgetOptions).then(function(n) {
										var i = t.state.rawData,
											o = dt(oe({}, i, n), e);
										t.setState({ rawData: oe({}, i, n), data: o, isLoading: !1 }), ee()(o.jsonLd);
									}),
							...
							value: function() {
								...
								new Promise(function(t, e) {
									navigator.geolocation
										? navigator.geolocation.getCurrentPosition(t, e, { timeout: 1e4 })
										: e(new Error(''));
								})
									.then(function(n) {
										var i = t.state,
											...
											r = i.data,
											a = n.coords,
											s = { latitude: a.latitude, longitude: a.longitude };
										t.setState({
											rawData: oe({}, o, { userLocation: s }),
											data: r && dt(oe({}, o, { userLocation: s }), e),
										});
									})
									.catch(function() {});
							},
									...
									(function(t) {
										var e = t.appId,
											...
											l = {
												...
												date: ''.concat(c, ',').concat(s),
											},
											u = 'https://rest.bandsintown.com/artists/'.concat(n, '/events'),
											p = V(u, l);
										return Kt()(p).then(function(t) {
											return t.json();
										});
									})(e.widgetOptions).then(function(n) {
										var i = t.state.rawData;
										t.setState({
											rawData: oe({}, i, { pastEvents: n }),
											data: dt(oe({}, i, { pastEvents: n }), e),
											isLoading: !1,
											showingPastEvents: !0,
						...
						},
						{
							...
							value: function() {
								this.state.pastEventsDataHasBeenFetched
									? this.setState({ showingPastEvents: !0 })
						...
						},
						{
							...
							value: function() {
								...
								this.setState({
									...
									responsiveLogoLayout: (function(t) {
									...
									n = oe(
										{
											...
											responsiveLogoLayout: e.responsiveLogoLayout,
											isLoading: e.isLoading,
											showingPastEvents: e.showingPastEvents,
										},
										this.props
									);
								return p(
					...
					be.forEach(function(i) {
						...
						e[o] ||
							(n[o] = (function(t, e, n) {
								...
								'a' === n && i.setAttribute('href', '#'), t.appendChild(i);
			...
			return (
				(function(t, e, n) {
				...
				})(t, [
					{
						key: 't',
						value: function(t) {
							return t && this.phrases[t] ? this.phrases[t] : t;
						},
					},
				]),
				t
		...
		var ye = n(16),
				...
				return (
					o()(e, function(t, e) {
						n[e] = (function(t) {
							var e = t.toLowerCase(),
								n = !isNaN(Number(t));
							return '' === t ? void 0 : 'true' === e || ('false' !== e && (n ? Number(t) : t));
						})(t.trim());
					}),
					n.artistName && (n.artistName = n.artistName.toString()),
					n
				);
			},
			_e = function(t, e) {
				var n = (function(t) {
						...
						return t;
					})({}, e.autoStyle ? ve(t, e) : {}, e),
					i = xe(n, ke.styleOptions);
				return ye(i, Se);
			},
			Te = function(t) {
				var e = xe(t, ke.widgetOptions);
				return ye(e, Pe);
			},
			Me = function(t) {
				return we(['de', 'en', 'es', 'fr', 'it', 'ja', 'pt'], t) ? t : 'en';
			},
			Oe = function(t) {
				var e = t.affilCode,
					n = t.appId,
			...
			Ce = function(t) {
				...
				if (i && document.getElementById(i))
					t.parentNode.removeChild(t), document.getElementById(i).appendChild(n);
				else {
					var o = t;
			...
			Le = function(t, e) {
				...
				i.setAttribute('class', 'bit-widget-container'), t.appendChild(i), G(p(ue, { options: n }), i);
			};
		window.Promise || n(34).polyfill(),
			(window.BIT = window.BIT || {}),
			Object(Ze.docReady)(function() {
				var t = document.querySelectorAll('.bit-widget-initializer');
				o()(t, function(t) {
					return Ce(t);
				}),
					a()(De.a);
				...
				e.observe(document.body, { childList: !0 }),
					(window.BIT.widgetInitializer = { append: Le, mutationObserver: e }),
